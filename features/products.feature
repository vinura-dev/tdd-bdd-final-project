Feature: The product store service back-end
    ...
    Scenario: Delete a Product
        ...
        Then I should see "Product has been Deleted!" as the flash message
        When I visit the "Home Page"
        And I press the "Clear" button
        And I set the "Name" to "Hat"
        And I press the "Search" button
        Then I should not see "A red fedora" in the results
    ...
    Scenario: Search matching Products by Name
        When I visit the "Home Page"
        And I press the "Clear" button
        And I change "Name" to "Big Mac"
        And I press the "Search" button
        Then I should see "Success" as the flash message
        And I should see "Big Mac" in the "Name" field
        And I should see "1/4 lb burger" in the "Description" field

    Scenario: Search matching Products by Category
        When I visit the "Home Page"
        And I press the "Clear" button
    ...
    Scenario: Search matching Products by Availability
        When I visit the "Home Page"
        And I press the "Clear" button
        And I select "True" in the "Available" dropdown
        And I press the "Search" button
