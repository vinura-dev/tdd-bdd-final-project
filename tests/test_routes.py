...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        """It should get the product using product id"""
    ...
    def test_get_invalid_product(self):
        """It should fail to get the product using product id"""
    ...
    def test_update_product(self):
        ...
        product_data["description"] = "unknown"
    ...
    def test_delete_product(self):
        ...
        # delete the product
        product_data = response.get_json()
        response = self.client.delete(f"{BASE_URL}/{product_data['id']}")
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
        response = self.client.get(f"{BASE_URL}/{product_data['id']}")
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_query_by_availability(self):
        ...
        found_count = len([product for product in products if product.available == availability])
